<?php
	...
	$perintah_sql = "SELECT * FROM user a JOIN okupansi b ON a.nik=b.nik_petugas JOIN frame_odp c ON b.id_frame_odp=c.id_frame_odp JOIN jabatan d ON a.jabatan=d.id_jabatan WHERE a.jabatan=2
		";
	$datas = [];
	$i=1;
