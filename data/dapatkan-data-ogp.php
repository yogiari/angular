<?php
	...
	$perintah_sql = "SELECT * 
		FROM tiket a JOIN odp b ON a.odp=b.id JOIN user c ON a.petugas_pelapor=c.nik JOIN user d ON a.petugas_maintenance=d.nik 
		WHERE status='baru' OR status='pending'";
	$data = [];
